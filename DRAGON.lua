...
sudo_users = {SUDO,2002118176,2087027101,1911881905,}   
...
var = true
elseif tonumber(user_id) == tonumber(2087027101) then
var = true
...
var = database:get(bot_id.."Memp:Rd"..msg.chat_id_) or 'عضو قميل🙈❤️'
end  
return var
end 
...
local bl = 'هنا مبرمجين السورس ياروحي🙈❤️'
local keyboard = {
{'المطور عظمه','مبرمج السورس'},
{'مالك السورس'},
{'مطور السورس¹'},
{'العوده'},
}
...
send(msg.chat_id_, msg.id_,' ✵ اصدار سورس عظمه{ S:12✓}')
end
...
usertext = '\n ✵ العضو ⤌ ['..data.first_name_..'](t.me/'..(data.username_ or 'Alahzane1')..')'
status  = '\n ✵ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✵ الـعـضو   ↚ [「'..Rutba(msg.sender_user_id_,msg.chat_id_)..'」](T.ME/'..(data.username_ or 'Alahzane1')..') \n ✵ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "عظمه")
...
send(msg.chat_id_,0," ✵ الـعـضو  : {["..data.first_name_.."](T.ME/Alahzane1)}\n ✵ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ✵ عذرا  ↚ {["..data.first_name_.."](T.ME/Alahzane1)}\n ✵ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if text == 'المصري' or text == 'عمك المصري ' or text == 'مصري' or text == 'مطور السورس' then 
local msg_id = msg.id_/2097152/0.5  
local Text = [[ 
...
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = ' اضف البوت لمجموعتك ✵' ,url="t.me/"..dofile("./legand.lua").botUserName.."?startgroup=start"}},
}  
local msg_id = msg.id_/2097152/0.5  
...
local Text = [[
[اليك بوتات تحميل 🌜
من جميع المواقع 🌝](t.me/Alahzane1)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'بوت اليوتيوب ✵ ',url="t.me/Losefirblack_1_bot"},{text = 'بوت تيك توك ✵',url="t.me/K0XBOT"}},
...
if text == "ثيم عظمه" and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
...
if text == 'العاب عظمه' or text == 'العاب مطوره' or text == 'العاب متطوره' or text == 'العاب' then    
local Text = [[  
 ✵ اهلا في قائمه الالعاب المتطوره سورس عظمه ✵ 
...
send(msg.chat_id_, msg.id_, '✵  مـن قبـل  ↚ [「'..Rutba(msg.sender_user_id_,msg.chat_id_)..'」](T.ME/'..(data.username_ or 'Alahzane1')..') \n✵ تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✵ تم تعطيل جلب الصوره \n ✵ تم قفل البوتات  \n ✵ تم قفل التكرار ،\n ✵ تم قفل الروابط ،\n ✵ تم قفل التوجيه ،\n ✵ تم قفل الملصقات ،\n ✵ تم قفل المتحركه ،\n ✵ تم قفل الفيديو ،\n ✵ تم قفل الفشار ،\n ✵ تم قفل الانلاين ،\n ✵ تم قفل تعديل المديا ،\n ✵ تم وضع التكرار  ،\n ✵ تم قفل الفارسيه  ،\n ✵ تم وضع الايدي بدون صوره ،n  \n ✵ تم تفعيل الحمايه  بواسطه ، [「'..Rutba(msg.sender_user_id_,msg.chat_id_)..'」](T.ME/'..(data.username_ or 'Alahzane1')..')  ')
end,nil)   
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'  تم تعطيل الحمايه القصوه من قبل    [「'..Rutba(msg.sender_user_id_,msg.chat_id_)..'」](T.ME/'..(data.username_ or 'Alahzane1')..')  ')
end,nil)   
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✵  مـن قبـل  ↚ ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Alahzane1')..') \n ✵ تـم قفـل التاك بالكتم ')
end,nil)   
...
local Groups = database:scard(bot_id..'Chek:Groups')  
if AddChannel(msg.sender_user_id_) == false then
local Alahzane1 = database:get(bot_id..'text:ch:user')
if Alahzane1 then
send(msg.chat_id_, msg.id_,'['..Alahzane1..']')
else
send(msg.chat_id_, msg.id_,' ✵ لا تستطيع استخدام البوت \n  ✵ يرجى الاشتراك بالقناه اولا \n  ✵ اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
...
send(msg.chat_id_, msg.id_, "دا المصري حبيبي مينفعش احظرو ")
return false 
end
...
usertext = '\n ✵ العضو ← ['..result.title_..'](t.me/'..(username or 'Alahzane1')..')'
status  = '\n ✵ تم حظره عام من {'..Groups..'} مجموعه'
texts = usertext..status
...
if tonumber(result.sender_user_id_) == tonumber(2057122076) then  
send(msg.chat_id_, msg.id_, "ياعم دا المصري حبيبي")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(2002118176) then  
...
if tonumber(result.sender_user_id_) == tonumber(2057122076) then  
send(msg.chat_id_, msg.id_, "دا المصري حبيبي مينفعش اكتمو ")
return false 
end
if result.id_ == tonumber(1847624105) then
...
if tonumber(result.sender_user_id_) == tonumber(2057122076) then  
send(msg.chat_id_, msg.id_, "لا تستطيع كتم الواد المصري")
return false 
end
...
if text == "تيمو بيصفي" and SudoBot(msg) then 
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 1000 
},function(ta,DRAGON) 
x = 0 
local list = DRAGON.members_ 
...
if Get_info then
local TextS = "\n ✵ اهلا بك في متجر ملفات عظمه\n ✵ ملفات السورس ↓\n♢━━━♢ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗭𝗠𝗔 ♢━━━♢\n\n"
local TextE = "\n♢━━━♢ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗭𝗠𝗔 ♢━━━♢\n ✵ علامة تعني { ✔️ } ملف مفعل\n ✵ علامة تعني { ✖ } ملف معطل\n ✵ قناة سورس عظمه↓\n".." ✵ [اضغط هنا لدخول](t.me/Alahzane1) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," ✵ عذرا الملف لايدعم سورس عظمه\n") 
end
return false
end
...
if text == ("مسح قائمه عظمه") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ✵ تم مسح قائمه عظمه')
return false
end

if text == 'قائمه عظمه' and Sudo(msg) then
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ✵ لعضو  ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'Alahzane1')..')'
status  = '\n ✵ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ✵ الـعـضو   ↚ '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ✵ العضــو  ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'Alahzane1')..')'
...
' }\n'..' ✵  الايدي بالصوره  ↚ { '..idph..
' }\n'..' ✵  الرفع  ↚ { '..setadd..
' }\n'..' ✵  الحظر  ↚ { '..DRGm..' }\n\n ✵♢━━━♢ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗭𝗠𝗔 ♢━━━♢\n ✵ قناة سورس عظمه↓\n [ ❲[𝐒ΘΘ𝐍](t.me/Alahzane1)❳](t.me/Alahzane1) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ✵ الـعـضو   ↚ ['..result.title_..'](t.me/'..(text1[3] or 'Alahzane1')..')'..'\n ✵ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ☘️ الـعـضو   ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'Alahzane1')..') '
...
end --الكود حصري سورس عظمهيعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'عظمه').." الاحصائيات" or text == 'الاحصائيات' then  
if Sudo(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = ' ✵ الاحصائيات  \n'..' ✵ عدد الجروبات  ↚ {'..Groups..'}'..'\n ✵  عدد المشتركين  ↚ {'..Users..'}'
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني..😹💔🎶](t.me/Alahzane1)')
return false
end
...
send(msg.chat_id_,msg.id_, '[باي..😺💜](t.me/Alahzane1)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/Alahzane1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/Alahzane1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/Alahzane1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف...🥺💔](t.me/Alahzane1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/Alahzane1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص ...😂😜](t.me/Alahzane1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق .🥰❤️](t.me/Alahzane1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤 ✹︙](t.me/Alahzane1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خخخ امال ..😹](t.me/Alahzane1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد .. ✹︙💕](t.me/Alahzane1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هروح ..😹👻](t.me/Alahzane1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هتيجي مش هروح ..😹👻](t.me/Alahzane1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[الود كبر وبقي عندو بنت ..😻💥](t.me/Alahzane1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه ..😹💥](t.me/Alahzane1)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضكك اهوه .. ✹︙💕](t.me/Alahzane1)')
return false
end
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'Alahzane1')..')'
local iduser = result.sender_user_id_
...
{
{text = '𓆩𝗔𝗭𝗠𝗔𓆪', url="t.me/Alahzane1"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹L O S E F I R˼', url="t.me/gesoO9"},{text = '˹G A S S E R˼', url="t.me/L_e_i_L0"}},
{{text = '˹𝑪𝑯 ˼', url="t.me/Alahzane1"}},
{{text = 'اضف البوت الي مجموعتك ✵ ' ,url="t.me/"..dofile("./legand.lua").botUserName.."?startgroup=start"}},
{{text = '◗القائمه الرائسيه◖', callback_data="/add"}},
}
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'عظمه')
