...
{
{text = '𝚉𝙾𝙳𝙸𝙰𝙲 📖', callback_data="/units"},{text = '𝙶𝙰𝙼𝙴𝚂 🎮', callback_data="/add"},
},
{
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'sᴏᴜʀᴄᴇ 𝘏𝘈𝘛𝘉𝘈', url="t.me/su_hatba"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard.inline_keyboard = {
{
{text = 'sᴏᴜʀᴄᴇ 𝘏𝘈𝘛𝘉𝘈', url = "https://t.me/su_hatba"},
},
}
local function getpro(extra, result, success) 
if result.photos_[0] then 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'sᴏᴜʀᴄᴇ 𝘏𝘈𝘛𝘉𝘈', url="t.me/su_hatba"}},{{text = '˹ᴛᴀᴡᴏsʟ˼', url="t.me/NINKJBOT"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard.inline_keyboard = {
{
{text = 'sᴏᴜʀᴄᴇ ᴍᴀᴛᴇɪx', url = "https://t.me/su_hatba"},
},
}
local function getpro(extra, result, success) 
if result.photos_[0] then 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'sᴏᴜʀᴄᴇ 𝘏𝘈𝘛𝘉𝘈', url="t.me/SOURCEDRAGON"}},
}
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯ ˹sᴏᴜʀᴄᴇ 𝘏𝘈𝘛𝘉𝘈˼',url="t.me/su_hatba"}},{{text = 'ᴍʏ ᴜsᴇʀ ❦︎',url="t.me/g_0_p"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '•ᴍʏ ᴅᴇᴠ ⸙', callback_data="/units"},{text = 'sᴏᴜʀᴄᴇ 𝘏𝘈𝘛𝘉𝘈', callback_data="/theytry"}},   
{{text = '𓆩الـــمـطـــور𓆪', url="http://t.me/"..sudos.UserName}},
{{text = '𖤍 اضافه البوت لمجموعتك 𖤍' ,url="t.me/"..dofile("./Info.lua").botUserName.."?startgroup=start"}}, 
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'sᴏᴜʀᴄᴇ 𝘏𝘈𝘛𝘉𝘈',url='http://t.me/su_hatba'}},
}
