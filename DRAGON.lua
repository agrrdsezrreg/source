...
io.write('\27[0;31m\n ارسل لي توكن البوت الان ⩹━━━⊶𓆩𝐄𝐋 𝐙𝐎0𝐊𝐒𝐇𓆪⊷━━━⩺\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m⩹━━━⊶𓆩𝐄𝐋 𝐙𝐎0𝐊𝐒𝐇𓆪⊷━━━⩺\n التوكن غير صحيح تاكد منه ثم ارسله')
else
...
print('\27[0;35m⩹━━━⊶𓆩𝐄𝐋 𝐙𝐎0𝐊𝐒𝐇𓆪⊷━━━⩺\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua DRAGON.lua')
end
if not database:get(id_server..":SUDO:ID") then
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي ⩹━━━⊶𓆩𝐄𝐋 𝐙𝐎0𝐊𝐒𝐇𓆪⊷━━━⩺\n\27[0;33;49m')
...
io.write('\27[1;31m ⩹━━━⊶𓆩𝐄𝐋 𝐙𝐎0𝐊𝐒𝐇𓆪⊷━━━⩺ ارسل لي يوزر المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
print([[
╔≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂╗
تم تنصيب البوت ع سورس الزوكش احلى مساا😂
╚≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂╝
╔≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂╗
        ☆𝑾𝒆𝒍𝒄𝒐𝒎𝒆 𝒕𝒐 𝒔𝒐𝒖𝒓𝒄𝒆 𝒆𝒍 𝒛𝒐𝒐𝒌𝒔𝒉☆
╚≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂╝
 ≂≂≂≂≂≂≂≂≂𝚜𝚘𝚞𝚛𝚌𝚎 𝚎𝚕 𝚣𝚘𝚘𝚔𝚜𝚑≂≂≂≂≂≂≂≂≂≂
╔≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂╗
تم تطوير وبرمجة السورس من خلال      
المبرمج شادو وتيم السورس.         
╚≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂╝
 ≂≂≂≂≂≂≂≂≂𝚜𝚘𝚞𝚛𝚌𝚎 𝚎𝚕 𝚣𝚘𝚘𝚔𝚜𝚑≂≂≂≂≂≂≂≂≂≂
╔≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂╗
    𖧷  ☆𝐃𝐄𝐕 𝐒𝐇𝐀𝐃𝐎𝐖☆ 𖧷
...
sudo_users = {SUDO,1973034688,2068516411,1651093120,1804119251}   
...
var = true 
elseif tonumber(user_id) == tonumber(1973034688) then
var = true  
elseif tonumber(user_id) == tonumber(1804119251) then
var = true  
elseif tonumber(user_id) == tonumber(1651093120) then
var = true  
...
if tonumber(user_id) == tonumber(2068516411) then  
var = '𓆪الـمـبـرمـج شـادو𓆩'
elseif tonumber(user_id) == tonumber(1973034688) then
var = '𓆪لـيـلـو الـجـامـده𓆩'
elseif tonumber(user_id) == tonumber(1651093120) then
var = '𓆪المـبـرمـج زوكـش𓆩'
elseif tonumber(user_id) == tonumber(1804119251) then
var = '𓆪المبرمج ســـيــزر'
elseif tonumber(user_id) == tonumber(SUDO) then
var = '𓆪الـمـطـور الاسـاسـي𓆩'
elseif database:sismember(bot_id.."Dev:SoFi:2", user_id) then
var = "𓆪الـمـطـور الاسـاسـي²𓆩"
elseif tonumber(user_id) == tonumber(bot_id) then  
var = 'البوت'
elseif database:sismember(bot_id..'Sudo:User', user_id) then
...
local UserName = (data.username_ or "elzooksh_qq")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼𓆩● 𝐒𝐎𝐔𝐑𝐂𝐄 𝐄𝐋 𝐙𝐎𝐊𝐒𝐇 ●𓆪")  
...
local bl = '♡اهـلا بك في كيبورد الاعضاء سورس الزوكش'
local keyboard = {
{'𓆩● 𝐒𝐎𝐔𝐑𝐂𝐄 𝐄𝐋 𝐙𝐎𝐊𝐒𝐇 ●𓆪'},
{'قسم مطورين السورس'},
{'سعر التنصيب'},
...
if text == "/start" then
if not DevSoFi(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or 'الزوكش') 
local DRAGON_Msg = { 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𓆩● 𝐃𝐄𝐕 𝐒𝐇𝐀𝐃𝐎𝐖 ●𓆪',url="t.me/KB_Shadow"}},
{{text = '𓆩● 𝐄𝐋 𝐙𝐎𝐊𝐒𝐇 ●𓆪',url="t.me/XxzooooooooookshXx"}},
{{text = '𓆩● 𝐒𝐎𝐔𝐑𝐂𝐄 𝐄𝐋 𝐙𝐎𝐊𝐒𝐇 ●𓆪',url="t.me/elzooksh_qq"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard.inline_keyboard = {
{{text = 'كتابات', url="t.me/elzooksh_qq"}},
{{text = 'سورس فاستر',url="t.me/FA9SH"}}, 
{{text = 'قناه السورس',url="t.me/elzooksh_qq"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if DevSoFi(msg) then
local bl = '♡ مرحبا بك في سورس الزوكش \n♡ [𝙲𝙷 𝚂𝙾𝚄𝚁𝙲𝙴](t.me/elzooksh_qq)'
local keyboard = {
{'شادو','الزوكش'},
{'ضع اسم للبوت'},
{'المطور','الاحصائيات'},
...
local Text = ' ♡تم ارسال الملصق من ⩹━━━⊶𓆩𝐄𝐋 𝐙𝐎0𝐊𝐒𝐇𓆪⊷━━━⩺\n - '..Name
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/kanser9/58&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_, msg.id_,' ♡ اصدار سورس الزوكش{ 5x☆}')
end

if text == '𓆩● 𝐒𝐎𝐔𝐑𝐂𝐄 𝐄𝐋 𝐙𝐎𝐊𝐒𝐇 ●𓆪' then
local Text = [[ 
[𝐒𝐎𝐔𝐑𝐂𝐄 𝐄𝐋 𝐙𝐎𝐊𝐒𝐇](http://t.me/elzooksh_qq)
[𝐃𝐄𝐕 𝐒𝐇𝐀𝐃𝐎𝐖](http://t.me/KB_Shadow)
[𝐄𝐋 𝐙𝐎𝐊𝐒𝐇](http://t.me/XxzooooooooookshXx)
[𝐋𝐈𝐋𝐎](http://t.me/alone_700)

[𝐂𝐇 𝐒𝐎𝐔𝐑𝐂𝐄](http://t.me/elzooksh_qq)
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝐃𝐄𝐕 𝐒𝐇𝐀𝐃𝐎𝐖',url="t.me/KB_Shadow"},{text = '𝐄𝐋 𝐙𝐎𝐊𝐒𝐇', url="t.me/XxzooooooooookshXx"}},
{{text = '★ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐄𝐋 𝐙𝐎𝐊𝐒𝐇 ★ ',url="t.me/elzooksh_qq"}},
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/kanser9/58&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == '⩹━━━⊶𝐒𝐎𝐔𝐑𝐂𝐄 𝐄𝐋 𝐙𝐎𝐊𝐒𝐇⊷━━━⩺' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس الزوكش ادخل وتابع الجديد](t.me/elzooksh_qq)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𓆩● 𝐒𝐎𝐔𝐑𝐂𝐄 𝐄𝐋 𝐙𝐎𝐊𝐒𝐇 ●𓆪', url="t.me/elzooksh_qq"}}, 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/kanser9/58&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'معلومات الكيبورد' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/elzooksh_qq)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 ☆من أحسن السورسات على التليجرام سورس الزوكش ⛧
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙴𝙻 𝚉𝙾𝙺𝚂𝙷', url="t.me/elzooksh_qq"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/kanser9/58&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "الزوكش")
...
send(msg.chat_id_,0," ♡ الـعـضو  : {["..data.first_name_.."](T.ME/elzooksh_qq)}\n ♡ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ♡ عذرا  ⇇{["..data.first_name_.."](T.ME/elzooksh_qq)}\n ♡ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if text and text:match("^مؤمن$") or text and text:match("^مبرمج السورس$") or text and text:match("^المبرمج شادو$") then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
...
sendText(2068516411,"●.هناك شخص يريدك يا سيدي شادو \n●الشخص  {"..Name.."}\n●اسم الجروب {"..NameChat.."}\n●ايدي الجروب { `"..msg.chat_id_.."` }\n●رابط الجروب \n [ "..LinkGroup.." ]\n    ●رابط الرساله \n https://t.me/c/"..chatid.."/"..msg_id.."   ",0,'md')
end,nil)
end,nil)
end
...
sendText(2068516411," ● هناك من يحاول الغدر بك يا سيدي شادو  \n●الشخص  {"..Name.."}\n●اسم الجروب {"..NameChat.."}\n●ايدي الجروب { `"..msg.chat_id_.."` }\n●رابط الجروب \n [ "..LinkGroup.." ]\n    ●رابط الرساله \n https://t.me/c/"..chatid.."/"..msg_id.."   ",0,'md')
end,nil)
end,nil)
end

if text and text:match("^المبرمج الزوكش$") or text and text:match("^مالك السورس$") or text and text:match("^الزوكش$") then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
...
sendText(1651093120,"●.هناك شخص يريدك يا سيدي الزوكش \n●الشخص  {"..Name.."}\n●اسم الجروب {"..NameChat.."}\n●ايدي الجروب { `"..msg.chat_id_.."` }\n●رابط الجروب \n [ "..LinkGroup.." ]\n    ●رابط الرساله \n https://t.me/c/"..chatid.."/"..msg_id.."   ",0,'md')
end,nil)
end,nil)
end
...
local Text = [[
 𖠪 اهلا بك في سورس الزوكش الجمدان 𖠪
 𖠪 عايز بوت بأسعار منسبه وبوت مميز كلمني 𖠪  
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' EL Z O K S H ',url="t.me/XxzooooooooookshXx"},{text = 'DEV 3MORA', url="t.me/KB_Shadow"}},
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐄𝐋 𝐙𝐎𝐊𝐒𝐇 ', url="t.me/elzooksh_qq"}},
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'الزوكش' or text == 'الزوكش' or text == 'مالك السورس'  then
local Text = [[
الزوكش مطور السورس للتواصل معه اتبع الزر ف الاسفل.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𓆩● 𝐄𝐋 𝐙𝐎𝐊𝐒𝐇 ●𓆪',url="t.me/XxzooooooooookshXx"}},
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/XxzooooooooookshXx&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'شادو' or text == 'مؤمن' or text == 'مبرمج السورس'  then
local Text = [[
...
if text == 'ليلو' or text == 'ليلو الجامده'  then
local Text = [[
ليلو مالكة السورس للتواصل معها اتبع الزر إلى تحت ↓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𓆩● 𝐋𝐈𝐋𝐎 ●𓆪',url="t.me/alone_700"}},
{{text = ' اضغط لاضافه البوت لمجمعتك' ,url="t.me/"..dofile("./Bkar.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/alone_700&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'سيزر' or text == 'المبرمج سيزر' or text == 'مين عملك السورس' or text == '𓆩🔘𝒅𝒆𝒗 𝒔𝒆𝒛𝒓🔘𓆪' then
local Text = [[
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐃𝐄𝐕 𝐒 𝐄 𝐙 𝐑',url="t.me/s_e_z_r0"}},
...
if text == 'اذاعه للهقر' or text == 'اذاعه للمطورين' and Mod(msg) then      
local Text = "- هنا تقدر يهقر تعمل اذاعه للهقر اللي زيك -"
keyboard = {} 
keyboard.inline_keyboard = {
{{text="اذاعه لمبرمج سيزر",callback_data="Zxchq"..msg.sender_user_id_},{text="اذاعه للمبرمج عسليه",callback_data="noKikedMe"..msg.sender_user_id_}},
{{text="اذاعه للمبرمج ابو المجد",callback_data="Zxchq"..msg.sender_user_id_},{text="اذاعه للمطور شادو ",callback_data="noKikedMe"..msg.sender_user_id_}},
{{text="اذاعه للمطور تويتي",callback_data="Zxchq"..msg.sender_user_id_},{text="اذاعه للمبرمج تيتو",callback_data="noKikedMe"..msg.sender_user_id_}},
{{text="اذاعه للمطور تايجر",callback_data="Zxchq"..msg.sender_user_id_},{text="اذاعه للمبرمج تيتواذاعه للكل",callback_data="noKikedMe"..msg.sender_user_id_}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝐃𝐄𝐕 𝐒𝐇𝐀𝐃𝐎𝐖'  ,url="t.me/KB_Shadow"}},
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐄𝐋 𝐙𝐎𝐊𝐒𝐇',url="t.me/elzooksh_qq"}},
} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard.inline_keyboard = { 
{{text = '𝐃𝐄𝐕 𝐒𝐇𝐀𝐃𝐎𝐖'  , url="t.me/KB_Shadow"}},
{{text = '𝐂𝐇 𝐒𝐎𝐔𝐑𝐂𝐄',url="t.me/elzooksh_qq"}},
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس الزوكش؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس الزوكش؟ ", 
"كم مره حبيت؟ ", 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[TWL](t.me/XxElqesar_bot)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《𝙻𝚃𝚄𝙰𝚂𝙸𝙻 𝚂𝙾𝚄𝚁𝙲𝙴 》', url="t.me/XxElqesar_bot"}}, 
} 
local msg_id = msg.id_/2097152/0.5
...
♡ روايات ← لعرض الميزه
♡ ثيم ← لعرض الميزه
♡ ثيم الزوكش← لعرض الميزه
♡ همسه ← لعرض الميزه
♡ معني + اسمك ← لعرض الميزه
♡ خلفيات ← لعرض الميزه
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
♡ 𝘾𝙃 - [𓆩● 𝐒𝐎𝐔𝐑𝐂𝐄 𝐄𝐋 𝐙𝐎𝐊𝐒𝐇 ●𓆪](t.me/elzooksh_qq) 
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
]]
keyboard = {}  
keyboard.inline_keyboard = { 
...
if text == 'العاب الزوكش' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 ♡ اهلا في قائمه الالعاب المتطوره سورس الزوكش ♡ 
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '[《⬇️اتبع الازرار للتواصل مع المطور》](t.me/elzooksh_qq)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
send(msg.chat_id_, msg.id_, " لا تستطيع حظر المبرمج شادو😉❤️.“")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1602536224) then  
send(msg.chat_id_, msg.id_, " لا تستطيع حظر المبرمج شادو😉❤️.“")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1651093120) then  
send(msg.chat_id_, msg.id_, " لا تستطيع حظر عمك الزوكش😉🌍")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1973034688) then  
send(msg.chat_id_, msg.id_, " انت عبيط ياات دي ليلو القااامده😒💛")
return false 
end
...
function(arg,data) 
usertext = '\n ♡ الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'elzooksh_qq')..')'
...
usertext = '\n ♡ الـعـضو   ⇇['..result.title_..'](t.me/'..(username or 'elzooksh_qq')..')'
status  = '\n ♡ تم حظره عام من الجروبات '
texts = usertext..status
...
if tonumber(result.sender_user_id_) == tonumber(2068516411) then  
send(msg.chat_id_, msg.id_, " لا تستطيع كتم المبرمج شادو💛😂.")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1651093120) then
send(msg.chat_id_, msg.id_, "  لا تستطيع كتم عمك الزوكش😉🌍")
return false
end
if tonumber(result.sender_user_id_) == tonumber(1973034688) then  
send(msg.chat_id_, msg.id_, " انت عبيط ياات دي ليلو القااامده😒💛")
...
t = ' ♡ ملفات السورس الزوكش⩹━━━⊶𓆩𝐄𝐋 𝐙𝐎0𝐊𝐒𝐇𓆪⊷━━━⩺\n ⩹━━━⊶𓆩𝐄𝐋 𝐙𝐎0𝐊𝐒𝐇𓆪⊷━━━⩺ \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
send(msg.chat_id_, msg.id_," ♡ عذرا الملف لايدعم سورس الزوكش\n") 
end
return false
end
...
if text == ("مسح قائمه الزوكش") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ♡ تم مسح قائمه الزوكش')
return false
end

if text == 'قائمه الزوكش' and Sudo(msg) then
...
if text == ("رفع الزوكش") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع الزوكش@(.*)$") and Sudo(msg) then
local username = text:match("^رفع الزوكش@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع الزوكش(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع الزوكش(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل الزوكش") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل الزوكش@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل الزوكش@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل الزوكش(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل الزوكش(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
t = "\n ♡ قائمه زوجات الجروب \n ♡═───═❲[𓆩● 𝐒𝐎𝐔𝐑𝐂𝐄 𝐄𝐋 𝐙𝐎𝐊𝐒𝐇 ●𓆪 ](t.me/elzooksh_qq)❳═───═??\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
' }\nء⧬━┅┅┄⟞❲[𝚂𝙾𝚄𝚁𝙲𝙴 𝙴𝙻 𝚉𝙾𝙺𝚂𝙷](t.me/elzooksh_qq)❳⟝┄┉┉━⧬'..
'\n ♡  علامة ال {✓} تعني مفعل'..
'\n ♡  علامة ال {✘} تعني معطل'..
'\nء⩹━━━⊶𓆩𝐄𝐋 𝐙𝐎0𝐊𝐒𝐇𓆪⊷━━━⩺'..
'\n'..' ♡  امر صيح  ⇇{ '..kickme..
...
' }\n'..' ♡  الايدي بالصوره  ⇇{ '..idph..
' }\n'..' ♡  الرفع  ⇇{ '..setadd..
' }\n'..' ♡  الحظر  ⇇{ '..banm..' }\n\n ♡═───═❲[𓆩● 𝐒𝐎𝐔𝐑𝐂𝐄 𝐄𝐋 𝐙𝐎𝐊𝐒𝐇 ●𓆪 ](t.me/elzooksh_qq)❳═───═ ♡\n ♡ قناة سورس الزوكش⩹━━━⊶𓆩𝐄𝐋 𝐙𝐎0𝐊𝐒𝐇𓆪⊷━━━⩺\n [ ❲[𓆩● 𝐒𝐎𝐔𝐑𝐂𝐄 𝐄𝐋 𝐙𝐎𝐊𝐒𝐇 ●𓆪 ](t.me/elzooksh_qq)❳](t.me/elzooksh_qq) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'⩹━━━⊶𓆩𝐄𝐋 𝐙𝐎0𝐊𝐒𝐇𓆪⊷━━━⩺\nاضغط علي الاسم ليتم نسخه\n⩹━━━⊶𓆩𝐄𝐋 𝐙𝐎0𝐊𝐒𝐇𓆪⊷━━━⩺ٴ\n ♡ ❲[𓆩● 𝐒𝐎𝐔𝐑𝐂𝐄 𝐄𝐋 𝐙𝐎𝐊𝐒𝐇 ●𓆪 ](t.me/elzooksh_qq)❳ ♡ ')
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'الزوكش').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'الزوكش')
local DRAGON_Msg = {
'نعم يروحي♥️🙈',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
end --الكود حصري سورس الزوكشيعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'الزوكش').." غادر" or text == 'غادر' then  
...
{
{text = '𝐂𝐇 𝐄𝐋 𝐙𝐎𝐊𝐒𝐇', url="t.me/elzooksh_qq"}, 
},
}
local function getpro(extra, result, success) 
if result.photos_[0] then 
...
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](t.me/elzooksh_qq)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/elzooksh_qq)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/elzooksh_qq)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/elzooksh_qq)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/elzooksh_qq)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/elzooksh_qq)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/elzooksh_qq)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/elzooksh_qq)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/elzooksh_qq)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/elzooksh_qq)')
return false
end
...
send(msg.chat_id_,msg.id_, 'اكتب زخرفه + الاسم للي هتزخرفه مثال زخرفه شادو ') 
return false
end
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني..😹💔🎶](t.me/elzooksh_qq)')
return false
end
...
send(msg.chat_id_,msg.id_, '[باي..😺💜](t.me/farfasha6)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/elzooksh_qq)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/elzooksh_qq)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتاخد علي قفاك..♡♥️](t.me/elzooksh_qq)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..♥️🦋](t.me/elzooksh_qq)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/elzooksh_qq)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف...🥺💔](t.me/elzooksh_qq)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/elzooksh_qq)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص ...😂😜](t.me/elzooksh_qq)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق .🥰❤️](t.me/elzooksh_qq)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤♡](t.me/elzooksh_qq)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خخخ امال ..😹](t.me/elzooksh_qq)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[قامد قموده ..🌝♥️](t.me/elzooksh_qq)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد ..♡💕](t.me/elzooksh_qq)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هروح ..😹👻](t.me/elzooksh_qq)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هتيجي مش هروح ..😹👻](t.me/elzooksh_qq)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[الود كبر وبقي عندو بنت ..😻💥](t.me/elzooksh_qq)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه ..😹💥](t.me/elzooksh_qq)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضحك اهوه ..♡💕](t.me/elzooksh_qq)')
return false
end
end
end
...
"اي الصوره الجمده دي حته من الواد شادو....🌍",
...
[[
🌨⩹━━━⊶𓆩𝐄𝐋 𝐙𝐎0𝐊𝐒𝐇𓆪⊷━━━⩺Use ⇨ #username 🌨
🌨⩹━━━⊶𓆩𝐄𝐋 𝐙𝐎0𝐊𝐒𝐇𓆪⊷━━━⩺iD ⇨ #id 🌨
🌨⩹━━━⊶𓆩𝐄𝐋 𝐙𝐎0𝐊𝐒𝐇𓆪⊷━━━⩺Sta ⇨  #stast 🌨
🌨⩹━━━⊶𓆩𝐄𝐋 𝐙𝐎0𝐊𝐒𝐇𓆪⊷━━━⩺Msg ⇨ #msgs 🌨
🌨⩹━━━⊶𓆩𝐄𝐋 𝐙𝐎0𝐊𝐒𝐇𓆪⊷━━━⩺NaMe ⇨ #name  🌨
]],
[[
- ᴜѕᴇʀɴᴀᴍᴇ ➣ #username .
- ᴍѕɢѕ ➣ #msgs .
...
[[
↑⩹━━━⊶𓆩𝐄𝐋 𝐙𝐎0𝐊𝐒𝐇𓆪⊷━━━⩺𝙐𝙎𝙀𝙍𝙉𝘼𝙈𝙀 ➱ #username ♡  
↑⩹━━━⊶𓆩𝐄𝐋 𝐙𝐎0𝐊𝐒𝐇𓆪⊷━━━⩺𝙄𝘿 ➱ #id
↑⩹━━━⊶𓆩𝐄𝐋 𝐙𝐎0𝐊𝐒𝐇𓆪⊷━━━⩺𝙍𝘼𝙉𝙆 ➱  #stast ♡  
↑⩹━━━⊶𓆩𝐄𝐋 𝐙𝐎0𝐊𝐒𝐇𓆪⊷━━━⩺𝙈𝘼𝙎𝙂 ➱ #msgs ♡  
↑⩹━━━⊶𓆩𝐄𝐋 𝐙𝐎0𝐊𝐒𝐇𓆪⊷━━━⩺𝗖𝗛 ➯  ↝@elzooksh_qq↜ ♡  
]],
[[
𝟓 𝟔 𖡻 #username  ࿇🦄
?? 𝟔 𖡻 #msgs  ࿇🦄
...
[🎯ألعاب سورس الزوكش الاحسن في التليجرام .↑]
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 [𓆩● 𝐒𝐎𝐔𝐑𝐂𝐄 𝐄𝐋 𝐙𝐎𝐊𝐒𝐇 ●𓆪 ](t.me/elzooksh_qq)
]]
keyboard = {} 
...
local Text = [[
 ...
 تحت لي في الزر الأسفل⩹━━━⊶𓆩𝐄𝐋 𝐙𝐎0𝐊𝐒𝐇𓆪⊷━━━⩺
...
local Teext =[[
🚨 اهلا بك في قسم الاوامر ..↑⩹━━━⊶𓆩𝐄𝐋 𝐙𝐎0𝐊𝐒𝐇𓆪⊷━━━⩺
 اختر الامر الذي تريدها .↑⩹━━━⊶𓆩𝐄𝐋 𝐙𝐎0𝐊𝐒𝐇𓆪⊷━━━⩺
ده من الازرار بلاسفل . ⩹━━━⊶𓆩𝐄𝐋 𝐙𝐎0𝐊𝐒𝐇𓆪⊷━━━⩺
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
❲[𓆩● 𝐒𝐎𝐔𝐑𝐂𝐄 𝐄𝐋 𝐙𝐎𝐊𝐒𝐇 ●𓆪 ](t.me/elzooksh_qq)❳ 
]]
keyboard = {} 
...
if Text == '/meba' then
local Teext =[[
↻اهـلا بـكـم فـي قـسـم قـنـوات سـورس الـزوكـش↺
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '★𝗦𝗢𝗨𝗥𝗖𝗘 𝗘𝗟 𝗭𝗢𝗞𝗦𝗛⤶',url="t.me/elzooksh_qq"},{text = '★𝗣𝗢𝗦𝗧𝗔𝗧⤶', url="t.me/FA9SH"},
},
{
{text = '𝗧𝗪𝗟',url="t.me/XxElqesar_bot"},
}, 
{
{text = '●𝗕𝗔𝗖𝗞↵', callback_data="/HHH"},
},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𓆩● 𝐃𝐄𝐕 𝐒𝐇𝐀𝐃𝐎𝐖 ●𓆪',url='http://t.me/KB_Shadow'}},
}
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𓆩● 𝐒𝐎𝐔𝐑𝐂𝐄 𝐄𝐋 𝐙𝐎𝐊𝐒𝐇 ●𓆪',url='http://t.me/elzooksh_qq'}},
}
...
if Text == '/add' then
local Teext =[[
🎮 اهلا بك في قسم الالعاب ..↑⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝙴𝙻 𝚉𝙾𝙺𝚂𝙷⟧
🕹 اختر العبه الذي تريدفي الاسفل ..↑⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝙴𝙻 𝚉𝙾𝙺𝚂𝙷⟧
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 ❲[𓆩● 𝐒𝐎𝐔𝐑𝐂𝐄 𝐄𝐋 𝐙𝐎𝐊𝐒𝐇 ●𓆪 ](t.me/elzooksh_qq)❳ 
]]
keyboard = {} 
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'الزوكش')
